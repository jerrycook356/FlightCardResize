        ...
        public DataManip()
        {
            ...
            using (var connection = new SQLiteConnection(pathToDatabase))
            {
                ...
                if (!info.Any())
                {
                    ...
                    connection.Insert(new LeaseTable() { leaseName = "Roberts Family" });
                    connection.Insert(new LeaseTable() { leaseName = "Peplinski Family" });
                    connection.Insert(new LeaseTable() { leaseName = "Bill Multiple" });
                    connection.Insert(new LeaseTable() { leaseName = "Gemini Group" });
                }
            ...
            using (var connection = new SQLiteConnection(pathToDatabase))
            {
                ...
                if (!info.Any())
                {
                    ...
                    connection.Insert(new PilotsTable() { pilotName = "Trever & Ryan" });
                }
            };
            using (var connection = new SQLiteConnection(pathToDatabase))
            {
                ...
                if (!info.Any())
                {
                    ...
                    connection.Insert(new PlaneTypeTable() { planeType = "Caravan C" });
                    connection.Insert(new PlaneTypeTable() { planeType = "Caravan" });
                    connection.Insert(new PlaneTypeTable() { planeType = "Caravan NP" });
                    connection.Insert(new PlaneTypeTable() { planeType = "Caravan P" });
